...
if pkg.get('devDependencies',{}).get('@types/node')!='24.13.4': fail('@types/node must match the reviewed Node 24 line')
...
print('AUDIT OK: structure, SBOM tests, lock markers, supported runtime, patched baselines, hardening governance, secret scan, dangerous sinks, and client/server boundaries passed.')

...
REQUIRED = [
    ...
    'ARCHITECTURE.md', 'DESIGN_SYSTEM.md', 'pnpm-lock.yaml', 'pnpm-workspace.yaml',
    'public/brand-mark.svg', 'src/app/layout.tsx', 'src/app/page.tsx',
    'src/app/api/health/route.ts', 'src/components/navigation/nav-links.tsx',
]
SECRET_PATTERNS = [
...
if client_modules != EXPECTED_CLIENT_MODULES:
    fail(f'client-module budget changed: expected {sorted(EXPECTED_CLIENT_MODULES)}, got {sorted(client_modules)}')
